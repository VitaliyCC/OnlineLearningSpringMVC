...
VALUES ('LAB#1test', 0, 'https://mix.sumdu.edu.ua/2_ERD.pdf', '10');
INSERT INTO TASK (TASK_NAME, SUBJECT_ID, SUBJECT, MAX_GRADE)
...
VALUES (0, 'https://mix.sumdu.edu.ua/index.html1', ' 19-02-22', 0, 'LAB#1test');
INSERT INTO Report (REPORT_ID, SOLUTION, SEND_DATE, STUDENT_ID, TASK_NAME)
VALUES (1, 'https://mix.sumdu.edu.ua/index.html1', ' 19-02-25', 0, 'LAB#1test');
INSERT INTO Report (REPORT_ID, SOLUTION, SEND_DATE, STUDENT_ID, TASK_NAME)
...
Commit;
--------------------------------------------
select * from Task where TASK_NAME='LAB#1';
SELECT SUM(grade)
FROM Review
...
SELECT * FROM REVIEW
    JOIN REPORT R on Review.report_id = R.REPORT_ID
WHERE task_name='LAB#1' AND student_id =0 AND ROWNUM<=1
...
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('5', '2', 'SAVOSTIA', 'VITALI', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('6', '3', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('7', '4', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('8', '5', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('9', '6', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('10', '7', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('11', '8', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('12', '9', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('13', '10', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('14', '11', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('15', '1', 'SAVOSTIAN', 'VITALIY', 'V');
INSERT INTO STUDENTS (STUDENT_ID, ID, SURNAME, NAME, PATRONYMIC)
VALUES ('15', '1', 'SAVOSTIAN', 'VITALIY', 'V');
commit;
INSERT INTO Iogin_info (id, password, username, role)
VALUES (4, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (5, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (6, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (7, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (8, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (9, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (10, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');
INSERT INTO Iogin_info (id, password, username, role)
VALUES (11, '$2a$12$5FW3nAcugaWNuKTK/cxQE.HEykTAjJzUMPIrFW4MR1hJVat9Kd3OS', 'VITALIIT', 'TEACHER');