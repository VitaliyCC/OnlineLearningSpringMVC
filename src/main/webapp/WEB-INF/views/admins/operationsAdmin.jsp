...
<div class="container">
    <div class="container">
        ...
        <table class="table table-bordered">
            <thead>
            <tr>
                <th>Admin id (click to see full info)</th>
                <th>Name</th>
                <th>Surname</th>
                <th>Patronymic</th>
                <th>Click to edit</th>
            ...
            <tr>
                ...
                <th><%=admin.getPatronymic()%>
                </th>
                <th><a class="link-secondary" href="/operation/admin/edit?id=<%=admin.getAdminId()%>"
                >Edit</a>
                </th>
            </tr>
            <%}%>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="/operation/admin/add"
