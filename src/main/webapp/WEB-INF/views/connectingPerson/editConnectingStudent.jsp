...
<div class="container mt-3">
    <form th:method="PATCH" th:action="@{/operation/connectingPerson/S/{id}(id=${connectingS.getId()})}"
          th:object="${connectingS}"
...
<div class="container mt-3">
    <br>
    <form class="form_" th:method="DELETE" th:action="@{/operation/connectingPerson/S/{id}(id=${connectingS.getId()})}">
